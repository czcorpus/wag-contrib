...
class UjcBasicApi<T> implements LexDictApi<UjcBasicArgs, T> {
    ...
    call(
        ...
        return streaming
            ...
            : ajax$<T>(HTTP.Method.GET, this.apiURL, queryArgs);
    }
    ...
    getSourceDescription(
        ...
        return rxOf({
            ...
            title: this.apiServices.importExternalMessage({
                ...
                'en-US':
                    'Příruční slovník jazyka českého (1935–1957) UNTRANSLATED',
            }),
    ...
    getSourceDescription(
        ...
        return rxOf({
            ...
            title: this.apiServices.importExternalMessage({
                ...
                'en-US':
                    'Slovník spisovného jazyka českého (1960–1971) UNTRANSLATED',
            }),
            description: this.apiServices.importExternalMessage({
                'cs-CZ':
                ...
                'en-US':
                    'Slovník spisovného jazyka českého vycházel knižně v letech 1960–1971 a obsahuje 197 200 hesel české slovní zásoby s jejich výklady a typickými příklady užití. Ústav pro jazyk český AV ČR v roce 2011 zveřejnil jeho digitalizovanou podobu. UNTRANSLATED',
            }),
            author: 'Ústav pro jazyk český AV ČR',
