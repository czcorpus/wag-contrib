    ...
    const ComparisonTable: React.FC<{
        ...
        return (
            <LS.DataTable>
                <thead>
                    <tr>
                        <th>{ut.translate('lex_overview__comparison_positive')}</th>
                        <th>{ut.translate('lex_overview__comparison_comparative')}</th>
                        <th>{ut.translate('lex_overview__comparison_superlative')}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        return (
            <LS.DataTable>
                ...
                <tbody>{pipe(
                    ...
                    List.map((data, i) =>
                        <tr key={`${i}:${data[0]}`}>
                            <td>{ut.translate(`lex_overview__case_${data[0]}`)}</td>
            ...
            <LS.DataTable>
                ...
                <tbody>
                    {pipe(
                        ...
                        List.map(data =>
                            <tr>
                                <td>{ut.translate(`lex_overview__conjugation_person_${data[0]}`)}</td>
                                <td className='word'>{data[1].singular}</td>
                                <td className='word'>{data[1].plural}</td>
                            </tr>
                        )
                    ...
                    {!!props.conjugationData.imperative.singular || !!props.conjugationData.imperative.singular ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_imperative')}</td>
                    ...
                    {!!props.conjugationData.participle.active ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_participle_active')}</td>
                            <td className='word' colSpan={2}>{props.conjugationData.participle.active}</td>
                        </tr> : null}
                    {!!props.conjugationData.participle.passive ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_participle_passive')}</td>
                    ...
                    {!!props.conjugationData.transgressive.past.m.singular || !!props.conjugationData.transgressive.past.m.plural ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_transgressive_past_m')}</td>
                    ...
                    {!!props.conjugationData.transgressive.past.zs.singular || !!props.conjugationData.transgressive.past.zs.plural ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_transgressive_past_zs')}</td>
                    ...
                    {!!props.conjugationData.transgressive.present.m.singular || !!props.conjugationData.transgressive.present.m.plural ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_transgressive_present_m')}</td>
                    ...
                    {!!props.conjugationData.transgressive.present.zs.singular || !!props.conjugationData.transgressive.present.zs.plural ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_transgressive_present_zs')}</td>
                    ...
                    {!!props.conjugationData.verbalNoun ?
                        <tr>
                            <td>{ut.translate('lex_overview__conjugation_verbal_noun')}</td>
    ...
    const LangGuideSubtileView: React.FC<{
        ...
        return <S.Subtile color={props.color || defaultColor}>
            <S.SubtileRow>
                ...
                {props.data.gender ?
                    <S.SubtileRow>
                        <span className='key'>{ut.translate('lex_overview__overview_gender')}:</span>
            ...
            {!!props.data.comparison.comparative || !!props.data.comparison.superlative ?
                <S.SubtileRow>
                    <span className='key'>{ut.translate('lex_overview__comparison')}</span>
                    <ComparisonTable positive={props.data.heading} comparisonData={props.data.comparison} />
                </S.SubtileRow> : null}

            {Dict.some(item => !!item.singular || !!item.plural , props.data.grammarCase) ?
                <S.SubtileRow>
                    <span className='key'>{ut.translate('lex_overview__case')}:</span>
                    <CaseTable caseData={props.data.grammarCase} />
                </S.SubtileRow> : null}

            {Dict.some(item => !!item.singular || !!item.plural , props.data.conjugation.person) ?
                <S.SubtileRow>
                    <span className='key'>{ut.translate('lex_overview__conjugation')}</span>
                    <ConjugationTable conjugationData={props.data.conjugation} />
                </S.SubtileRow> : null}

            <S.SubtileRow className='footer'>
                <span className='key'>Zdroj:</span><span className='value'>Internetová jazyková příručka</span>
            </S.SubtileRow>
        </S.Subtile>
    }
